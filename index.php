      ...
      <style>
          ...
          */
          @font-face {
              ...
              font-style: normal;
              font-weight: 400;
              src: url("./captiveportal-Oswald.eot");
              /* Hack IE 9 */
              src: local('Oswald Regular'), local('Oswald-Regular'),
              url("./captiveportal-Oswald.eot?#iefix") format('embedded-opentype'),
              url("./captiveportal-Oswald.woff2") format('woff2'),
              url("./captiveportal-Oswald.woff") format('woff'),
              url("./captiveportal-Oswald.ttf") format('truetype'),
              url("./captiveportal-Oswald.svg?#Oswald-Regular") format('svg');
              /* ?#iefix Hack IE 5-8 */
              unicode-range:
              U+0000-00FF,
              U+0131,
